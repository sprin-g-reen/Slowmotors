...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottomContent: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discover: Schema.Attribute.Component<'homepage.discover', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    founders: Schema.Attribute.Component<'homepage.founders', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    map: Schema.Attribute.Component<'homepage.map', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dates: Schema.Attribute.Component<'tour.dates', true>;
    ...
    faq: Schema.Attribute.Component<'tour.faq', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    introText: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    pricing: Schema.Attribute.Component<'tour.pricing', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickFacts: Schema.Attribute.Component<'tour.quick-facts', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
