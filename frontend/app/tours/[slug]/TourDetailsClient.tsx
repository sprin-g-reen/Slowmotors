...
import { BlocksRenderer } from "@/lib/strapiBlocks";
import DatesEnquiryModal from "@/components/DatesEnquiryModal";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <div className="prose prose-lg text-gray-600 space-y-4">
                {Array.isArray(introText) && introText.length > 0 && typeof introText[0] === 'string' ? (
                  introText.map((paragraph, index) => (
                    <p key={index}>{paragraph}</p>
                  ))
                ) : (
                  <BlocksRenderer content={introText as any} />
                )}
              </div>
            </div>
                    ...
                    <div className="p-8 md:w-2/3 flex flex-col justify-center">
                      ...
                      <div className="text-gray-600">
                        {typeof day.description === 'string' ? (
                          ...
                          <BlocksRenderer content={day.description} />
                        )}
                      </div>
                    </div>
                  </div>
          ...
          <div className="bg-gray-900 text-white rounded-2xl p-8 md:p-12">
            ...
            <div className="mt-8 text-center">
              <button
                ...
                className="bg-primary text-white px-8 py-3 rounded-lg font-bold uppercase hover:bg-primary/90 transition-colors"
              >
                {bookButtonLabel}
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-3">
                {Array.isArray(included) && included.length > 0 && typeof included[0] === 'string' ? (
                  ...
                  <BlocksRenderer content={included as any} />
                )}
              </div>
            </div>
            <div>
              ...
              <div className="space-y-3">
                {Array.isArray(requirements) && requirements.length > 0 && typeof requirements[0] === 'string' ? (
                  <ul className="space-y-3">
                  ...
                  <BlocksRenderer content={requirements as any} />
                )}
              </div>
            </div>
          </div>
